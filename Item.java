...
public class Item
{
    ...
    /**
     * Creates an item with a name ex. "bottle", a description ex. "a cold
     * bottle of beer", and a weight in Kg ex. "0,5Kg".
     *
    ...
    /**
     * Returns the full details of the item; Name, Description, and Weigth in
     * KG.
     *
